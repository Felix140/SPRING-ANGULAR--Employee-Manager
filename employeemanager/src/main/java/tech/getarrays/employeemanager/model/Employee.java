...
//Serializable aiuta a trasformare le Classi Java in differenti tipi di STREAM

@Entity
public class Employee implements Serializable {

    //Trasformare i seguenti campi in campi del DB, JPA aiuterà in questo

    @Id
    @GeneratedValue(strategy = GenerationType.AUTO)
    @Column(nullable = false, updatable = false) // qui aggiungo le info sulla colonna
    private Long id; //Sara una PRIMARY KEY
